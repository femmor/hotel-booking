let mongoose,bcrypt;_f13‍.x([["default",()=>_f13‍.o]]);_f13‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_f13‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);
...
userSchema.pre("save", function (next) {
  ...
  if (user.isModified("password")) {
    return bcrypt.hash(user.password, 12, (err, hash) => {
      if (err) {
        _f13‍.g.console.log("BCRYPT HAS ERROR!", err);
        return next(err);
      }
      user.password = hash;
      return next();
